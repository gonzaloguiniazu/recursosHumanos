...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Tu código de barras para fichar - Legajo: ' . $nro_legajo;
    $mail->Body = "
        <p>Hola <strong>$nombre $apellido</strong>,</p>
        <p><strong>Tu número de legajo es: $nro_legajo</strong></p>
        <p>Este es tu código de barras personal para fichar:</p>
        <img src='cid:barcode_img' alt='Código de Barras'><br>
        <p style='text-align: center; font-weight: bold; margin-top: 10px;'>Legajo: $nro_legajo</p>
        <br>
        <p>Te recomendamos guardar esta imagen en tu celular junto con tu número de legajo.</p>
        <p><strong>Información importante:</strong></p>
        <ul>
            <li>Número de legajo: <strong>$nro_legajo</strong></li>
    ...
    echo '<form action="empleado.php" method="get">';
    echo '<button type="submit" style="padding:12px 24px; background-color:#007BFF; color:white; border:none; border-radius:5px; font-size:16px; cursor:pointer;">Volver</button>';
    echo '</form>';
