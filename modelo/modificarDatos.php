    ...
    <div class="form-container">
        ...
        if (isset($_POST['actualizar'])) {
            ...
            mysqli_query($conexion, "UPDATE empleados 
                SET dni='$nuevo_dni', nombre='$nombre', apellido='$apellido', telefono='$telefono', email='$email' 
        ...
        ?>
                <form method="post">
                    ...
                    <input type="hidden" name="dni_original" value="<?php echo $reg['dni']; ?>">
                    ...
                    <input type="submit" name="actualizar" value="Actualizar y Volver">
                </form>
        <?php
            } else {
        ...
        if (!isset($_POST['buscar']) || !isset($reg)) {
        ?>
        ...
        <div class="botones">
            <form action="../vista/admin.html" method="get">
                <input type="submit" value="Volver">
            </form>
            <form action="listaEmpleados.php" method="get">
                <input type="submit" value="Lista de empleados">
            </form>
        </div>
